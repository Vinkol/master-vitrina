        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex flex-col space-y-1.5">
            <div className="flex justify-between items-center px-1">
              ...
              <span className="text-[9px] font-bold text-rose-400 bg-rose-500/10 px-1.5 py-0.5 rounded-md border border-rose-500/10">
                Обязательно
              </span>
            </div>
            <input
              ...
              className="w-full rounded-2xl bg-slate-900 border border-slate-800/80 p-3.5 text-sm text-slate-100 placeholder-slate-500/70 transition-all duration-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 focus:outline-none disabled:opacity-40"
            />
          </div>

          {/* Инпут описания */}
          <div className="flex flex-col space-y-1.5">
            <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 px-1 font-mono">
            ...
            <textarea
              ...
              placeholder="Расскажите клиентам о вашем опыте, материалах или важных правилах отмены записей..."
              rows={4}
              className="w-full resize-none rounded-2xl bg-slate-900 border border-slate-800/80 p-3.5 text-sm text-slate-100 placeholder-slate-500/70 transition-all duration-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 focus:outline-none disabled:opacity-40"
            />
          </div>
          ...
          <div className="rounded-2xl border border-slate-800/50 bg-slate-900/30 p-3.5 flex items-center justify-between transition-all duration-200 hover:border-slate-800">
            ...
            <span className="text-[9px] font-black uppercase tracking-wider text-indigo-400 bg-indigo-500/10 px-2.5 py-1 rounded-xl border border-indigo-500/20 shadow-sm">
              Авто
            </span>
          </div>
