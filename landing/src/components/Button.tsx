...
export function Button<T extends ElementType = 'button'>({
  ...
  const variants = {
    popular:
      'appearance-none bg-indigo-600 bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-md shadow-indigo-200 dark:shadow-none transform-gpu',
    secondary:
      'bg-slate-50 hover:bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700/50 border border-slate-700/20',
  };
