...
export function Button<T extends ElementType = 'button'>({
  ...
  const variants = {
    popular: 'bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-500 dark:to-purple-500 text-white shadow-md shadow-indigo-200 dark:shadow-none',
    secondary: 'bg-slate-50 hover:bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700/50 border border-transparent dark:border-slate-700/50',
  };
